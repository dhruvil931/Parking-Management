...
const tiers = [
  {
    ...
    priceMonthly: "₹349",
    description:
      "Ideal for regular commuters and small parking owners who want better control and insights.",
    features: [
      "Owner dashboard",
      "Add & manage up to 20 parking spots",
  ...
  },
  {
    ...
    priceMonthly: "₹999",
    description:
      "Built for large parking operators, societies, malls, and commercial spaces requiring full automation.",
    features: [
      "Unlimited parking spots",
      "Staff / guard accounts",
      "Advanced analytics & occupancy reports",
      "Permission-based access",
      "Custom pricing & surge rates",
  ...
  return (
    <div className="relative isolate bg-gray-900 px-6 py-24 sm:py-32 lg:px-8">
      ...
      <p className="mx-auto mt-6 max-w-2xl text-center text-lg font-medium text-pretty text-gray-400 sm:text-xl/8">
        Smart, flexible plans designed for individuals, businesses, and parking
        owners who want efficiency, automation, and complete control. Each plan
        gives you the tools to manage parking effortlessly and scale as you
        grow.
      </p>
